...
static void update_dragonfly_effect(WORK_Other* ewk) {
...
s16 dragonfly_l_move_4(WORK_Other* ewk) {
    return dragonfly_turn_move_4(ewk);
}
...
static void update_dragonfly_wait_step_J8(WORK_Other* ewk) {
    ewk->wu.dir_timer--;
