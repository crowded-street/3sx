...
void Pattern14_0048(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        J_Command_Attack(wk, &(Command_Attack_Args){8, 0x8015, 0xA, -1});
        break;
...
void Pattern14_0049(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        J_Command_Attack(wk, &(Command_Attack_Args){8, 0x8016, 0xA, -1});
        break;
...
void Pattern14_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 0x37, 0x37, 0x36, 0x35});
        break;
...
void Pattern14_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x8016, 0xA, -1, -0x7FB0, -0x7FC0, 0, -1, -1, -1});
        break;
...
void Pattern14_0053(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x8014, 8, -1, -1, 0x20, 0, -1, -1, -1});
        break;
...
void Pattern14_0054(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x8014, 8, -1, -1, 0x20, 2, -1, -1, -1});
        break;
...
void Pattern14_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x8014, 8, -1, -1, 0x20, 1, -1, -1, -1});
        break;
...
void Pattern14_0067(PLW* wk) {
    ...
    case 2:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){0xB, 0x2F, 0xA, -1, -1, 0x40, 0, -1, -1, -1});
        break;
...
void Pattern14_0125(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x21, 0x3F, 0x40, 0x41}, 0);
        break;
...
void Pattern14_0126(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x23, 0x24, 0x25, 0x3D}, 0);
        break;
...
void Pattern14_0127(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x22, 0x43, 0x3C, 0x3E}, 0);
        break;
...
void Pattern14_0130(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x71, 0x72, 0x71, 0x72}, 0);
        break;
...
void Pattern14_0131(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x1A, 0x1C, 0x1D, 0x1E}, 0);
        break;
