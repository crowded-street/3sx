...
void Pattern06_0002(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 4, 5, 6, 6});
        break;
...
void Pattern06_0004(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x8215, 8, -1});
        break;
...
void Pattern06_0005(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x8215, 9, -1});
        break;
...
void Pattern06_0038(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F88, -0x7FC0, 9, 0x400, 0, -0x7F88, -1, 0x400});
        break;
...
void Pattern06_0039(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F68, -0x7FC0, 9, 0x200, 0, -0x7F68, -1, 0x400});
        break;
    default:
        End_Pattern(wk);
        break;
...
void Pattern06_0040(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F68, -0x7FC0, 9, 0x400, 0, -0x7F68, -1, 0x400});
        break;
...
void Pattern06_0043(PLW* wk) {
    ...
    case 1:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x1C, 0xA, 0x70});
        break;
...
void Pattern06_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x2F, 0x30, 0x35, 0x36}, 1);
        break;
...
void Pattern06_0058(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 0x3B, 0x3B, 0x3C, 0x3D});
        break;
...
void Pattern06_0062(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 0x21, 0x21, 0x22, 0x23});
        break;
...
void Pattern06_0063(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x3A, 0x3A, 0x3A, 0x36}, 5);
        break;
