...
void Pattern13_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 8, 0x40, 2, -0x7F90, 8, 0x20});
        break;
...
void Pattern13_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FB0, 8, 0x10, 0, -0x7F90, 8, 0x20});
        break;
...
void Pattern13_0021(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 8, 0x400, 0, -0x7F90, 8, 0x200});
        break;
...
void Pattern13_0027(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FB0, 0xB, 0x10, 0, -0x7F90, 8, 0x20});
        break;
...
void Pattern13_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 8, 0x400, 0, -1, -1, -1});
        break;
...
void Pattern13_0044(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 8, 0x40, 0, -1, -1, -1});
        break;
...
void Pattern13_0045(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-1, -0x7FC0, 8, 0x400, 0, -1, -1, 0xFFFF});
        break;
...
void Pattern13_0062(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x8016, 0xB, -1});
        break;
...
void Pattern13_0069(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7FA0, -0x7FC0, 8, 0x40, 0, -0x7F90, 8, 0x400});
        break;
...
void Pattern13_0075(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x1E, 0x4008, -1});
        break;
...
void Pattern13_0076(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x1E, 0x4009, -1});
        break;
...
void Pattern13_0077(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x1E, 0x400A, -1});
        break;
...
void Pattern13_0078(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x31, 0x31, 0x31, 0x4B}, 4);
        break;
...
void Pattern13_0079(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x32, 0x32, 0x31, 0x4C}, 4);
        break;
...
void Pattern13_0080(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Com_Random_Select(wk, &(Branch_Menu_Args){2, 0x31, 0x32, 0x33, 0x4C}, 4);
        break;
