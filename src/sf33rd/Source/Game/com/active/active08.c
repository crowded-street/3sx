...
void Pattern08_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7FA0, -0x7FC8, 8, 0x200, 2, -1, -0x7FF0, 0x100});
        break;
...
void Pattern08_0019(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        EM_Term(wk, &(EM_Term_Params){0x70, -1, 0, 2, 5});
        break;
...
void Pattern08_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        J_Command_Attack(wk, &(Command_Attack_Args){9, 0x1D, 0xA, -1});
        break;
...
void Pattern08_0022(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F98, -0x7FC0, 9, 0x40, 0, -0x7F90, -1, 0x100});
        break;
...
void Pattern08_0031(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F98, -0x7FC0, 8, 0x200, 0, -0x7F68, -1, 0x200});
        break;
...
void Pattern08_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F90, -0x7FC0, 8, 0x200, 0, -0x7F70, -1, 0x400});
        break;
...
void Pattern08_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F98, -0x7FC0, 8, 0x40, 0, -1, -0x7FE0, 0x200});
        break;
...
void Pattern08_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-0x7F98, -0x7FB8, 8, 0x400, 2, -1, -0x7FF0, 0x10});
        break;
...
void Pattern08_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-0x7F98, -0x7FB8, 8, 0x40, 0, -1, -0x7FF0, 0x10});
        break;
...
void Pattern08_0057(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        J_Command_Attack(wk, &(Command_Attack_Args){8, 0x8014, 0xA, -1});
        break;
...
void Pattern08_0068(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){9, 0x1F, 0xA, 0x700});
        break;
