...
void Pattern17_0020(PLW* wk) {
    active_pattern_command_attack_2(
        wk, &(Command_Attack_Args) { 8, 0x1C, 9, -1 }, &(Command_Attack_Args) { 8, 0x1E, 0xA, -1 }
    );
}
...
void Pattern17_0031(PLW* wk) {
    active_pattern_jump_attack_term_normal_attack(
        wk, &(Jump_Term_Args) { -1, 0x40, 0xB, 0x40, 0, -0x7FA0, -1, 0x200 }, 0x200
    );
}
...
void Pattern17_0054(PLW* wk) {
    active_pattern_sa_term_command_attack(
        wk, &(SA_Term_Args) { 0xFFFF, 0xFFFF, 0x30, 0 }, &(Command_Attack_Args) { 8, 0x1C, 0xA, -1 }
    );
}
...
void Pattern17_0076(PLW* wk) {
    active_pattern_lever_on_normal_attack_command_attack(
        wk, 0x12, 0x12, &(Command_Attack_Args) { 8, 0x1C, 0x4008, -1 }
    );
}
...
void Pattern17_0079(PLW* wk) {
    pattern_pierce_on_hi_jump_attack_term_lever_on_2(
        wk, &(Hi_Jump_Term_Args) { -1, 0x40, 8, 0x400, 0, -0x7FA0, -1, 0x200 }
    );
}
