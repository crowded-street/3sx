...
void Passive11_0185(PLW* wk) {
    active_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, -0x7FE8, 6, 1, -1}, 8, 0x20);
}
...
void Passive11_0197(PLW* wk) {
    active_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-0x7F70, 0x28, 7, 1, -1}, 8, 0x200);
}
...
void Passive11_0207(PLW* wk) {
    active_pattern_pierce_on_jump_com_random_select(wk, &(Branch_Menu_Args){6, 0x14, 0x15, 0x13, 0x25}, 4);
}

void Passive11_0208(PLW* wk) {
    active_pattern_pierce_on_jump_com_random_select(wk, &(Branch_Menu_Args){6, 0x14, 0x15, 0x16, 0xF1}, 3);
}

void Passive11_0209(PLW* wk) {
    active_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, -0x7FD0, 6, 1, -1}, 8, 0x200);
}
...
void Passive11_0225(PLW* wk) {
    active_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, -0x7FD0, 6, 1, -1}, 8, 0x402);
}
...
void Passive11_0232(PLW* wk) {
    active_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1C, 0xA, 0x70});
}
...
void Passive11_0236(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0x88, 0x8A, 0xEA, 0xEB}, 4);
}

void Passive11_0237(PLW* wk) {
    active_pattern_pierce_on_jump_com_random_select(wk, &(Branch_Menu_Args){6, 0xD2, 0xEC, 0xA1, 0xCF}, 5);
}
...
void Passive11_0239(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0x14, 0x15, 0x16, 0x16}, 4);
}
...
void Passive11_0241(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 1, 1, 1, 0xF0}, 3);
}

void Passive11_0242(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0xF0, 1, 1, 1}, 2);
}
...
void Passive11_0247(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0xF3, 0xF4, 0xA5, 0xF6}, 3);
}
...
void Passive11_0251(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0xF3, 0xF4, 0xA5, 0xFA}, 3);
}

void Passive11_0252(PLW* wk) {
    active_pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0xF3, 0x10, 0xA5, 0xFD}, 5);
}
