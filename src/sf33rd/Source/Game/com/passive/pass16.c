...
static void pattern_check_ex_jump_command_attack_term(PLW* wk, s16 next_menu, const JCA_Term_Args* a) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_wait_branch_unit_area(PLW* wk, s16 time, const Branch_Menu_Args* p) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, time);
        break;
...
void Passive16_0011(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, -0x7FB0, 0xB, 0x200, 2, -0x7FA0, -1, 0x20});
}
...
void Passive16_0026(PLW* wk) {
    pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, -0x7FB0, 6, 1, -1}, 8, 0x402);
}
...
void Passive16_0028(PLW* wk) {
    pattern_jump_attack(wk, &(Jump_Attack_Args){8, 10, 0x200, 1});
}
...
void Passive16_0030(PLW* wk) {
    pattern_em_term_normal_attack(wk, &(EM_Term_Params){-0x7F80, -0x7FB8, 6, 1, -1}, 8, 0x200);
}
...
void Passive16_0042(PLW* wk) {
    pattern_jump_attack(wk, &(Jump_Attack_Args){8, 0xF, 0x42, 0});
}
...
void Passive16_0084(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack(wk, &(Jump_Attack_Args){0xC, 0xF, 0x40, 0});
        break;
...
void Passive16_0092(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        EM_Term(wk, &(EM_Term_Params){-0x7FF0, -0x7FA0, 6, 1, -1});
        break;
...
void Passive16_0095(PLW* wk) {
    ...
    case 2:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){6, 0x69, 0x69, 0x68, 1});
        break;
...
void Passive16_0104(PLW* wk) {
    pattern_jump_command_attack_term(wk, &(JCA_Term_Args){8, 0x2E, 8, -1, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
}

void Passive16_0105(PLW* wk) {
    pattern_jump_command_attack_term(wk, &(JCA_Term_Args){8, 0x2E, 9, -1, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
}

void Passive16_0106(PLW* wk) {
    pattern_jump_command_attack_term(wk, &(JCA_Term_Args){8, 0x2E, 0xA, -1, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
}
...
void Passive16_0126(PLW* wk) {
    pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, 0x30, 6, 1, -1}, 8, 0x402);
}
...
void Passive16_0128(PLW* wk) {
    pattern_check_ex_jump_command_attack_term(
        wk,
        0x36,
...
void Passive16_0133(PLW* wk) {
    ...
    case 1:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x1D, 10, 0x70});
        break;
...
void Passive16_0139(PLW* wk) {
    pattern_jump_command_attack_term(wk, &(JCA_Term_Args){8, 0x2E, 0xA, 0x700, -0x7FA0, -0x7FA8, 2, -1, 0x30, 0x400});
}
...
void Passive16_0141(PLW* wk) {
    pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, -0x7FB0, 6, 1, -1}, 8, 0x40);
}
...
void Passive16_0145(PLW* wk) {
    ...
    case 1:
        SA_Term(wk, &(SA_Term_Args){0xFFFF, 0x2F, 0x30, 0xFFFF});
        break;
