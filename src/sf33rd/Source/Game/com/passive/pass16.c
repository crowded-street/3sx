...
void Passive16_0011(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FB0, 0xB, 0x200, 2, -0x7FA0, -1, 0x20});
        break;
...
void Passive16_0028(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack(wk, &(Jump_Attack_Args){8, 10, 0x200, 1});
        break;
...
void Passive16_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack(wk, &(Jump_Attack_Args){8, 0xF, 0x42, 0});
        break;
...
void Passive16_0069(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack(wk, &(Jump_Attack_Args){0xC, 0xF, 0, 0x40});
        break;
...
void Passive16_0104(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x2E, 8, -1, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
        break;
...
void Passive16_0105(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x2E, 9, -1, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
        break;
...
void Passive16_0106(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x2E, 0xA, -1, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
        break;
...
void Passive16_0128(PLW* wk) {
    ...
    case 1:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x2E, 9, 0x700, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
        break;
...
void Passive16_0134(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, &(Command_Attack_Args){8, 0x1E, 10, 0x70});
        break;
...
void Passive16_0135(PLW* wk) {
    ...
    case 1:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x2E, 0xA, 0x700, -0x7FA0, -0x7FA8, 0, -1, 0x30, 0x400});
        break;
...
void Passive16_0138(PLW* wk) {
    ...
    case 1:
        Jump_Command_Attack_Term(wk, &(JCA_Term_Args){8, 0x2E, 0xA, 0x700, -0x7FA0, -0x7FA8, 2, -1, 0x30, 0x400});
        break;
