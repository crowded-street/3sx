...
static void pattern_approach_walk_em_term_command_attack(
...
static void pattern_wait_get_up_normal_attack(PLW* wk, u16 lever_data, s16 option, u16 lever_data_b) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_approach_walk_em_term_command_attack_2(PLW* wk, s16 target_pos, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, target_pos, 2);
        break;
...
static void pattern_approach_walk_wait_get_up_wait(PLW* wk, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_approach_walk_check_ex_pierce_on(PLW* wk, s16 target_pos, s16 next_menu) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, target_pos, 2);
        break;
...
static void pattern_hi_jump_attack_term_normal_attack(PLW* wk, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_approach_walk_command_attack(PLW* wk, s16 target_pos, const Command_Attack_Args* p) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, target_pos, 2);
        break;
...
static void pattern_wait_get_up_com_random_select(PLW* wk, u16 lever_data, const Branch_Menu_Args* p) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_jump(PLW* wk, s16 time) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, time);
        break;
...
void Passive06_0022(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0x20, 8, -1});
}

void Passive06_0023(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0x20, 9, -1});
}

void Passive06_0024(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0x20, 10, -1});
}
...
void Passive06_0034(PLW* wk) {
    pattern_approach_walk_em_term_command_attack_2(wk, 0x80, 0x100);
}

void Passive06_0035(PLW* wk) {
    pattern_approach_walk_em_term_command_attack_2(wk, 0x60, 0x200);
}

void Passive06_0036(PLW* wk) {
    pattern_approach_walk_em_term_command_attack_2(wk, 0x80, 0x10);
}

void Passive06_0037(PLW* wk) {
    pattern_approach_walk_em_term_command_attack_2(wk, 0x80, 0x20);
}

void Passive06_0038(PLW* wk) {
    pattern_approach_walk_em_term_command_attack_2(wk, 0x80, 0x40);
}
...
void Passive06_0056(PLW* wk) {
    pattern_approach_walk_check_ex_pierce_on(wk, 0x58, 0x65);
}
...
void Passive06_0059(PLW* wk) {
    ...
    case 3:
        Com_Random_Select(wk, &(Branch_Menu_Args){6, 0x41, 0x2D, 0x31, 0x3C}, 1);
        break;
...
void Passive06_0071(PLW* wk) {
    pattern_approach_walk_wait_get_up_wait(wk, 0x100);
}

void Passive06_0072(PLW* wk) {
    pattern_approach_walk_wait_get_up_wait(wk, 0x200);
}

void Passive06_0073(PLW* wk) {
    pattern_approach_walk_wait_get_up_wait(wk, 0x10);
}

void Passive06_0074(PLW* wk) {
    pattern_approach_walk_wait_get_up_wait(wk, 0x20);
}

void Passive06_0075(PLW* wk) {
    pattern_approach_walk_wait_get_up_wait(wk, 0x40);
}
...
void Passive06_0078(PLW* wk) {
    pattern_wait_get_up_com_random_select(wk, 3, &(Branch_Menu_Args){6, 0x41, 0x2D, 0x31, 0x65});
}

void Passive06_0079(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 3, 0, 0x12);
}

void Passive06_0080(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 3, 0, 0x22);
}

void Passive06_0081(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 3, 0, 0x42);
}

void Passive06_0082(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 3, 0, 0x102);
}

void Passive06_0083(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 3, 0, 0x202);
}

void Passive06_0084(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 3, -1, 0x402);
}
...
void Passive06_0090(PLW* wk) {
    ...
    case 2:
        Com_Random_Select(wk, &(Branch_Menu_Args){6, 0x41, 0x2D, 0x31, 0x65}, 0);
        break;
...
void Passive06_0091(PLW* wk) {
    ...
    case 2:
        Com_Random_Select(wk, &(Branch_Menu_Args){6, 0x3C, 0x3D, 0x3F, 0x65}, 0);
        break;
...
void Passive06_0093(PLW* wk) {
    pattern_wait_get_up_normal_attack(wk, 0, 0, 0x200);
}

void Passive06_0094(PLW* wk) {
    pattern_wait_get_up_com_random_select(wk, 0, &(Branch_Menu_Args){6, 0x41, 0x2D, 0x31, 0x65});
}

void Passive06_0095(PLW* wk) {
    pattern_wait_get_up_com_random_select(wk, 0, &(Branch_Menu_Args){6, 0x3C, 0x3D, 0x3F, 0x65});
}

void Passive06_0096(PLW* wk) {
    pattern_approach_walk(wk, 0x44);
}

void Passive06_0097(PLW* wk) {
    pattern_approach_walk(wk, 0x9F);
}

void Passive06_0098(PLW* wk) {
    pattern_approach_walk(wk, 0xFF);
}
...
void Passive06_0100(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0, 8, -1});
}
...
void Passive06_0103(PLW* wk) {
    pattern_approach_walk_check_ex_pierce_on(wk, 0x80, 0x36);
}
...
void Passive06_0106(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        SA_Term(wk, &(SA_Term_Args){0xFFFF, 0xFFFF, 3, 0xFFFF});
        break;
...
void Passive06_0115(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-0x7FA8, -0x7FC0, 8, 0x200, 1, -0x7FA8, -1, 0x40});
}
...
void Passive06_0117(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-0x7F68, 0x40, 8, 0x40, 2, -0x7F68, -1, 0x400});
}
...
void Passive06_0119(PLW* wk) {
    pattern_approach_walk_check_ex_pierce_on(wk, 0x58, 0x6F);
}

void Passive06_0120(PLW* wk) {
    pattern_approach_walk_check_ex_pierce_on(wk, 0x58, 0x79);
}
...
void Passive06_0127(PLW* wk) {
    ...
    case 2:
        Com_Random_Select(wk, &(Branch_Menu_Args){6, 0x16, 0x13, 0x2C, 8}, 1);
        break;
...
void Passive06_0130(PLW* wk) {
    ...
    case 1:
        SA_Term(wk, &(SA_Term_Args){1, 0xFFFF, 0xFFFF, -1});
        break;
...
void Passive06_0134(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        SA_Term(wk, &(SA_Term_Args){1, 0xFFFF, 3, -1});
        break;
...
void Passive06_0140(PLW* wk) {
    pattern_hi_jump_attack_term_normal_attack(wk, 0x402);
}
...
void Passive06_0142(PLW* wk) {
    pattern_hi_jump_attack_term_normal_attack(wk, 0x42);
}

void Passive06_0143(PLW* wk) {
    pattern_hi_jump_attack_term_normal_attack(wk, 0x40);
}

void Passive06_0144(PLW* wk) {
    pattern_hi_jump_attack_term_normal_attack(wk, 0x20);
}
