...
static void pattern_approach_walk_em_term_lever_attack(PLW* wk, const EM_Term_Params* p, u16 lever, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_pierce_on_em_term_normal_attack(PLW* wk, const EM_Term_Params* p, s16 reaction, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Pierce_On(wk);
        break;
...
static void pattern_etc_term_command_attack(PLW* wk, u16 next_menu, const Command_Attack_Args* p) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_hi_jump_attack_term_normal_attack(
...
static void pattern_jump_attack_term_normal_attack(PLW* wk, const Jump_Term_Args* a, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, a);
        break;
...
void Passive00_0023(PLW* wk) {
    ...
    case 1:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 0xB, 0x10, 0, -1, -1, -1});
        break;
...
void Passive00_0027(PLW* wk) {
    pattern_approach_walk_em_term_lever_attack(wk, &(EM_Term_Params){-1, -0x7FA0, 6, 1, -1}, 1, 0x20);
}
...
void Passive00_0037(PLW* wk) {
    pattern_approach_walk_em_term_lever_attack(wk, &(EM_Term_Params){-1, -0x7FFE, 6, 1, -1}, 0, 0x110);
}
...
void Passive00_0056(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-1, -0x7FA8, 8, 0x100, 0, -1, -1, -1});
        break;
...
void Passive00_0057(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, -0x7FA8, 8, 0x10, 0, -1, -1, -1});
}
...
void Passive00_0061(PLW* wk) {
    pattern_etc_term_command_attack(wk, 0x99, &(Command_Attack_Args){8, 0x1C, 0xA, -1});
}
...
void Passive00_0068(PLW* wk) {
    pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0x59, 0x59, 0x59, 0x5a});
}
...
void Passive00_0076(PLW* wk) {
    ...
    case 1:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 8, 0x400, 0, -0x7F90, -1, 0x20});
        break;
...
void Passive00_0077(PLW* wk) {
    pattern_jump_attack_term_normal_attack(wk, &(Jump_Term_Args){-1, -0x7FC0, 0xB, 0x40, 0, -0x7F90, -1, 0x200}, 0x400);
}

void Passive00_0078(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 0xB, 0x400, 0, -0x7F90, -1, 0x20});
        break;
...
void Passive00_0079(PLW* wk) {
    pattern_jump_attack_term_normal_attack(wk, &(Jump_Term_Args){-1, -0x7FC0, 0xB, 0x40, 0, -1, -1, -1}, 0x40);
}
...
void Passive00_0082(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-1, -0x7FA0, 0xB, 0x40, 0, -1, -1, -1});
        break;
...
void Passive00_0083(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-1, -0x7FA0, 0xB, 0x400, 0, -0x7F90, -1, 0x20});
        break;
...
void Passive00_0084(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, &(Hi_Jump_Term_Args){-1, -0x7FA0, 0xB, 0x400, 0, -0x7F90, -1, 0x200});
        break;
...
void Passive00_0088(PLW* wk) {
    ...
    case 2:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-1, -0x7FC0, 0xB, 0x400, 0, -0x7F90, -1, 0x200});
        break;
...
void Passive00_0091(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0x1E, 0xA, -1});
}
...
void Passive00_0094(PLW* wk) {
    pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0x59, 0x5A, 0x5A, 0x5B});
}
...
void Passive00_0110(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0x1C, 0xA, -1});
}
...
void Passive00_0116(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, 0x10, 8, 0x400, 1, -1, 0x10, 0x400});
}

void Passive00_0117(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, 0x10, 8, 0x200, 1, -1, 0x10, 0x20});
}

void Passive00_0118(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, 0x10, 8, 0x20, 1, -1, 0x10, 0x20});
}

void Passive00_0119(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, 0x10, 8, 0x400, 0, -1, 0x10, 0x400});
}

void Passive00_0120(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, 0x10, 8, 0x200, 0, -1, 0x10, 0x20});
}

void Passive00_0121(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, 0x10, 8, 0x20, 0, -1, 0x10, 0x20});
}
...
void Passive00_0140(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-0x7F70, -1, 8, 0x40, 1, -1, 0x20, 0x40});
}
...
void Passive00_0142(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F70, -0x7FC0, 9, 0x40, 2, -1, -1, -1});
        break;
...
void Passive00_0145(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        EM_Term(wk, &(EM_Term_Params){-0x7F90, -1, 6, 1, -1});
        break;
...
void Passive00_0148(PLW* wk) {
    pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, -0x7FC0, 0xB, 0x400, 1, -0x7F90, -1, 0x400});
}
...
void Passive00_0153(PLW* wk) {
    pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0x59, 0x6E, 0x89, 0x98});
}

void Passive00_0154(PLW* wk) {
    pattern_com_random_select(wk, &(Branch_Menu_Args){6, 0x6C, 0x9B, 0x5A, 0x98});
}
...
void Passive00_0157(PLW* wk) {
    pattern_etc_term_command_attack(wk, 0x9A, &(Command_Attack_Args){8, 0x1E, 8, -1});
}
