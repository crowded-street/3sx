...
void Passive17_0066(PLW* wk) {
    pattern_approach_walk_command_attack(wk, 0x4B, &(Command_Attack_Args){8, 0x1F, 10, -1});
}
...
void Passive17_0074(PLW* wk) {
    pattern_sa_term_command_attack(wk, &(SA_Term_Args){0x2E, 0x2F, 0x30, 0}, &(Command_Attack_Args){8, 0x1F, 10, -1});
}
