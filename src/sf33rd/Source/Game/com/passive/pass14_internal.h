/*
 * Internal declarations for the pass14 pattern scripts.
 *
 * pass14.c holds the dispatcher and Passive14_Tbl, which names every pattern in
...
#ifndef PASS14_INTERNAL_H
#define PASS14_INTERNAL_H
