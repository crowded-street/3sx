...
static void pattern_approach_walk_lever_attack(PLW* wk, s16 target_pos, u16 lever_data) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_keep_away_wait_get_up(PLW* wk, u16 lever_data, s16 option) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Keep_Away(wk, 0xC7, 0);
        break;
...
static void pattern_forced_guard(PLW* wk, s16 guard_type) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void pattern_wait_get_up_j_command_attack(PLW* wk, const Command_Attack_Args* p) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait_Get_Up(wk, 0, 0);
        break;
...
void Passive07_0016(PLW* wk) {
    pattern_approach_walk_lever_attack(wk, 0x78, 0x200);
}
...
void Passive07_0020(PLW* wk) {
    pattern_approach_walk_lever_attack(wk, 0x3B, 0x110);
}

void Passive07_0021(PLW* wk) {
    pattern_approach_walk_lever_attack(wk, 0x3B, 0x400);
}

void Passive07_0022(PLW* wk) {
    pattern_approach_walk_lever_attack(wk, 0x3B, 0x202);
}
...
void Passive07_0033(PLW* wk) {
    pattern_approach_walk_lever_attack(wk, 0x3B, 0x200);
}
...
void Passive07_0050(PLW* wk) {
    pattern_normal_attack_j_command_attack(wk, 9, 0x10, &(Command_Attack_Args){8, 0x20, 9, -1});
}
...
void Passive07_0059(PLW* wk) {
    pattern_jump_command_attack_term(wk, &(JCA_Term_Args){8, 0x2E, 10, 0x70, -1, 0x40, 0, -1, -1, 0xFFFF});
}

void Passive07_0060(PLW* wk) {
    pattern_jump_command_attack_term(wk, &(JCA_Term_Args){8, 0x2E, 10, 0x70, -1, 0x40, 1, -1, -1, 0xFFFF});
}
...
void Passive07_0066(PLW* wk) {
    pattern_wait_get_up_j_command_attack(wk, &(Command_Attack_Args){8, 0x1C, 9, -1});
}
...
void Passive07_0068(PLW* wk) {
    pattern_command_attack(wk, &(Command_Attack_Args){8, 0x20, 10, 0x700});
}
...
void Passive07_0104(PLW* wk) {
    pattern_normal_attack_command_attack(wk, 9, 0x402, &(Command_Attack_Args){8, 0x1F, 9, -1});
}
...
void Passive07_0117(PLW* wk) {
    pattern_normal_attack_command_attack(wk, 9, 0x100, &(Command_Attack_Args){8, 0x1F, 10, -1});
}

void Passive07_0118(PLW* wk) {
    pattern_normal_attack_j_command_attack(wk, 9, 0x100, &(Command_Attack_Args){8, 0x1F, 9, -1});
}
...
void Passive07_0141(PLW* wk) {
    pattern_wait_get_up_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 0xA, -1});
}
...
void Passive07_0154(PLW* wk) {
    pattern_keep_away_wait_get_up(wk, 0, -1);
}

void Passive07_0155(PLW* wk) {
    pattern_keep_away_wait_get_up(wk, 2, -1);
}
...
void Passive07_0170(PLW* wk) {
    pattern_keep_away_wait_get_up(wk, 3, -1);
}

void Passive07_0171(PLW* wk) {
    pattern_keep_away_wait_get_up(wk, 0, 0);
}
...
void Passive07_0188(PLW* wk) {
    pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 0xA, -1});
}
...
void Passive07_0200(PLW* wk) {
    pattern_normal_attack_j_command_attack(wk, 0xC, 0x40, &(Command_Attack_Args){8, 0x20, 0xA, -1});
}
...
void Passive07_0204(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        EM_Term(wk, &(EM_Term_Params){-0x7F98, 0, 4, 2, 0});
        break;
...
void Passive07_0208(PLW* wk) {
    ...
    case 1:
        Com_Random_Select(wk, &(Branch_Menu_Args){6, 0xAF, 0xB0, 0x7C, 0x7B}, 1);
        break;
