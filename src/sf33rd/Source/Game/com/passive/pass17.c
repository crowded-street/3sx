...
void Passive17_0007(PLW* wk) {
    pattern_approach_walk_command_attack(wk, 0x7F, &(Command_Attack_Args){8, 0x1E, 9, -1});
}
...
void Passive17_0032(PLW* wk) {
    pattern_sa_term_command_attack(wk, &(SA_Term_Args){0x2E, 0x2F, 0xFFFF, 0}, &(Command_Attack_Args){8, 0x1F, 10, -1});
}
