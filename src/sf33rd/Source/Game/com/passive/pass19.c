...
void Passive19_0038(PLW* wk) {
    ...
    case 1:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 0x4B, 0x4B, 0x4B, 0x4B});
        break;
...
void Passive19_0039(PLW* wk) {
    ...
    case 1:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 0x4D, 0x4D, 0x4D, 0x4D});
        break;
...
void Passive19_0040(PLW* wk) {
    ...
    case 1:
        Branch_Unit_Area(wk, &(Branch_Menu_Args){2, 0x4E, 0x4E, 0x4E, 0x4E});
        break;
...
void Passive19_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack(wk, &(Jump_Attack_Args){8, 0xC, 0x400, 2});
        break;
...
void Passive19_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        EM_Term(wk, &(EM_Term_Params){-0x7F80, -0x7F80, 6, 1, -1});
        break;
...
void Passive19_0069(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack(wk, &(Jump_Attack_Args){0xC, 0xC, 0x400, 0});
        break;
...
void Passive19_0079(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack_Term(wk, &(Jump_Term_Args){-0x7F60, -0x7FB0, 0xB, 0x400, 0, -0x7FA0, -1, 0x20});
        break;
...
void Passive19_0135(PLW* wk) {
    ...
    case 1:
        J_Command_Attack(wk, &(Command_Attack_Args){8, 0x1F, 10, 0x700});
        break;
...
void Passive19_0139(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Attack(wk, &(Jump_Attack_Args){0xC, 0xD, 0x400, 2});
        break;
