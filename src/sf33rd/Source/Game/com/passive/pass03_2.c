...
void Passive03_0050(PLW* wk) {
    passive03_pattern_normal_attack_2(wk, 8, 0x12, 0x22);
}

void Passive03_0051(PLW* wk) {
    passive03_pattern_normal_attack(wk, 8, 0x220);
}

void Passive03_0052(PLW* wk) {
    passive03_pattern_normal_attack(wk, 8, 0x202);
}
...
void Passive03_0055(PLW* wk) {
    passive03_pattern_command_attack(wk, &(Command_Attack_Args){8, 0x20, 8, -1});
}

void Passive03_0056(PLW* wk) {
    passive03_pattern_jump_attack_term(wk, &(Jump_Term_Args){-0x7FA0, -0x7FD0, 8, 0x40, 0, -0x7FA0, -1, 0x40});
}

void Passive03_0057(PLW* wk) {
    passive03_pattern_jump_attack_term(wk, &(Jump_Term_Args){-0x7FA0, -0x7FD0, 8, 0x20, 0, -0x7FA0, -1, 0x40});
}
...
void Passive03_0059(PLW* wk) {
    passive03_pattern_normal_attack_2(wk, 0xB, 0x20, 0x40);
}
...
void Passive03_0063(PLW* wk) {
    pattern_normal_attack_command_attack(wk, 0xC, 0x20, &(Command_Attack_Args){8, 0x20, 9, -1});
}
...
void Passive03_0067(PLW* wk) {
    passive03_pattern_command_attack(wk, &(Command_Attack_Args){8, 0x20, 10, -1});
}
...
void Passive03_0089(PLW* wk) {
    passive03_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 8, -1});
}

void Passive03_0090(PLW* wk) {
    passive03_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 9, -1});
}

void Passive03_0091(PLW* wk) {
    passive03_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 10, -1});
}
...
void Passive03_0093(PLW* wk) {
    passive03_pattern_normal_attack_2(wk, 8, 0x102, 0x102);
}
...
void Passive03_0096(PLW* wk) {
    passive03_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-1, -0x7FF0, 6, 1, -1}, 0x402);
}
...
void Passive03_0101(PLW* wk) {
    passive03_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-0x7F80, -1, 6, 1, -1}, 0x20);
}
