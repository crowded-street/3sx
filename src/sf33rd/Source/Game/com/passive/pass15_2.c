...
void Passive15_0061(PLW* wk) {
    pattern_sa_term_command_attack(wk, &(SA_Term_Args){0x2E, 0x2F, 0xFFFF, 0}, &(Command_Attack_Args){8, 0x1E, 10, -1});
}
...
void Passive15_0068(PLW* wk) {
    passive15_pattern_jump_attack_term(wk, &(Jump_Term_Args){-0x7F60, -0x7FA0, 8, 0x200, 0, -0x7FA0, -1, 0x400});
}

void Passive15_0069(PLW* wk) {
    passive15_pattern_jump_attack(wk, &(Jump_Attack_Args){0xC, 0xC, 0x42, 0});
}
...
void Passive15_0089(PLW* wk) {
    passive15_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 8, -1});
}

void Passive15_0090(PLW* wk) {
    passive15_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 9, -1});
}

void Passive15_0091(PLW* wk) {
    passive15_pattern_j_command_attack(wk, &(Command_Attack_Args){8, 0x1F, 10, -1});
}
...
void Passive15_0093(PLW* wk) {
    passive15_pattern_normal_attack_2(wk, 0x102, 8, 0x12);
}

void Passive15_0094(PLW* wk) {
    passive15_pattern_lever_attack(wk, 0, 0x20);
}
...
void Passive15_0096(PLW* wk) {
    passive15_pattern_em_term_normal_attack(wk, &(EM_Term_Params){-0x7F80, -0x7FD8, 6, 1, -1}, 8, 0x402);
}
...
void Passive15_0103(PLW* wk) {
    passive15_pattern_normal_attack(wk, 8, 0x402);
}
...
void Passive15_0116(PLW* wk) {
    passive15_pattern_jump_attack_term(wk, &(Jump_Term_Args){-1, -0x7FA0, 0xB, 0x400, 0, -0x7FA0, -1, 0x20});
}

void Passive15_0117(PLW* wk) {
    passive15_pattern_jump_attack(wk, &(Jump_Attack_Args){8, 0xC, 0x100, 0});
}

void Passive15_0118(PLW* wk) {
    passive15_pattern_normal_attack(wk, 8, 0x200);
}
