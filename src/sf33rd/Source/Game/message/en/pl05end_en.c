...
static char* msgEndPL05_00[1] = { "" };
static char* msgEndPL05_01[2] = {
    "   Ahh!                                         ",
    "   We're cornered!!                             ",
};
static char* msgEndPL05_02[2] = {
    "   Don't say that! We can't stop!!              ",
    "   We must never give up! Run!!                 ",
};
static char* msgEndPL05_03[2] = {
    "   We're about to reach the woods of            ",
    "   the country border! Almost there!            ",
};
static char* msgEndPL05_04[1] = { "   They're on the roof!                         " };
static char* msgEndPL05_05[2] = {
    "   You! Go to the first car and we'll           ",
    "   attack them from both sides!                 ",
};
static char* msgEndPL05_06[2] = {
    "   We can never let them fall                   ",
    "   into the hands of the enemy!                 ",
};
static char* msgEndPL05_07[2] = {
    "   Their very cells pose                        ",
    "   a threat to us!                              ",
};
static char* msgEndPL05_08[1] = { "   Is this the end...?                          " };
static char* msgEndPL05_09[2] = {
    "   No... Not yet!                               ",
    "   Come with me, Effie!                         ",
};
static char* msgEndPL05_10[1] = { "   ...Iyaaaaaaaah!                              " };
static char* msgEndPL05_11[2] = {
    "   Aaaaah!!                                     ",
    "   Illiaaaaaaaaa!!                              ",
};
static char* msgEndPL05_12[1] = { "   Effieeeeee!!                                 " };
static char* msgEndPL05_13[1] = { "   It's a miracle...                            " };
static char* msgEndPL05_14[2] = {
    "   For the first time... I feel                 ",
    "   thankful for this body of mine!              ",
};

static char** msgEndAdrPL05[15] = {
