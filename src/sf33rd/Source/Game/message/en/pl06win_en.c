...
static char* msgWinPL06_00P[1] = { "" };
static char* msgWinPL06_01P[1] = { "" };
static char* msgWinPL06_02P[1] = { "" };
static char* msgWinPL06_03P[1] = { "" };
static char* msgWinPL06_04P[1] = { "" };
static char* msgWinPL06_05P[1] = { "" };
static char* msgWinPL06_06P[1] = { "" };
static char* msgWinPL06_07P[1] = { "" };
static char* msgWinPL06_08P[1] = { "" };
static char* msgWinPL06_09P[1] = { "" };
static char* msgWinPL06_10P[1] = { "" };
static char* msgWinPL06_11P[1] = { "" };
static char* msgWinPL06_12P[1] = { "" };
static char* msgWinPL06_13P[1] = { "" };
static char* msgWinPL06_14P[1] = { "" };
static char* msgWinPL06_15P[1] = { "" };
static char* msgWinPL06_16P[1] = { "" };
static char* msgWinPL06_17P[1] = { "" };
static char* msgWinPL06_18P[1] = { "" };
static char* msgWinPL06_19P[1] = { "" };
static char* msgWinPL06_20P[2] = {
    "   Would you be able to get up if I             ",
    "   sat down on you? Let's find out!             ",
};
static char* msgWinPL06_21P[1] = { "   I am number one!                             " };
static char* msgWinPL06_22P[2] = {
    "   The bigger I am, the                         ",
    "   harder they fall!                            ",
};
static char* msgWinPL06_23P[2] = {
    "   The force of your body smashed the           ",
    "   pavement! Help me fix it!                    ",
};
static char* msgWinPL06_24P[2] = {
    "   It's a natural instinct for you              ",
    "   to fear my size and strength!                ",
};
static char* msgWinPL06_25P[2] = {
    "   Strange... Is suicide a popular              ",
    "   activity where you come from?                ",
};
static char* msgWinPL06_26P[2] = {
    "   I held back. If I used any more              ",
    "   force, there would be a huge mess!           ",
};
static char* msgWinPL06_27P[2] = {
    "   You enjoyed that, didn't you?                ",
    "   Let's do it again!                           ",
};

static char** msgWinAdrPL06[28] = {
