...
static char* msgWinPL12_00P[1] = { "" };
static char* msgWinPL12_01P[1] = { "" };
static char* msgWinPL12_02P[1] = { "" };
static char* msgWinPL12_03P[1] = { "" };
static char* msgWinPL12_04P[1] = { "" };
static char* msgWinPL12_05P[1] = { "" };
static char* msgWinPL12_06P[1] = { "" };
static char* msgWinPL12_07P[1] = { "" };
static char* msgWinPL12_08P[1] = { "" };
static char* msgWinPL12_09P[1] = { "" };
static char* msgWinPL12_10P[1] = { "" };
static char* msgWinPL12_11P[1] = { "" };
static char* msgWinPL12_12P[1] = { "" };
static char* msgWinPL12_13P[1] = { "" };
static char* msgWinPL12_14P[1] = { "" };
static char* msgWinPL12_15P[1] = { "" };
static char* msgWinPL12_16P[1] = { "" };
static char* msgWinPL12_17P[1] = { "" };
static char* msgWinPL12_18P[1] = { "" };
static char* msgWinPL12_19P[1] = { "" };
static char* msgWinPL12_20P[2] = {
    "   Wow! That actually worked?!                  ",
    "   Next time I'll do it with skill!             ",
};
static char* msgWinPL12_21P[2] = {
    "   I'm so eager to try out new and              ",
    "   different things! This is great!             ",
};
static char* msgWinPL12_22P[2] = {
    "   Tell me who just rocked                      ",
    "   your world with skill!                       ",
};
static char* msgWinPL12_23P[2] = {
    "   With every match, my timing                  ",
    "   becomes more precise!                        ",
};
static char* msgWinPL12_24P[2] = {
    "   Oh yeah! I'll start using                    ",
    "   that move more often now!                    ",
};
static char* msgWinPL12_25P[2] = {
    "   My master was right... I have to             ",
    "   improve myself with every battle!            ",
};
static char* msgWinPL12_26P[2] = {
    "   Now I understand why they fight!             ",
    "   This feeling is incredible!                  ",
};
static char* msgWinPL12_27P[2] = {
    "   Call the fire department,                    ",
    "   cause I'm on fire, baby!                     ",
};

static char** msgWinAdrPL12[28] = {
