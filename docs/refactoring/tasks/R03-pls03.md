...
#### Step 6: `check_meoshi_cancel` (line 1665)
...
Commit message: `refactor(pls03): simplify check_meoshi_cancel`
...
```
  ...
  This file has 1794 lines, so one function can move the aggregate score by
  ...
  `git checkout -- src/sf33rd/Source/Game/engine/pls03.c` and move on.
