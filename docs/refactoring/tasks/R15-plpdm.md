# R15 - refactor `src/sf33rd/Source/Game/engine/plpdm.c`
...
```
code_health_review(file_path="E:/SynologyDrive/research/_agentic_refactoring/Street Fighter/git_win10/3sx/src/sf33rd/Source/Game/engine/plpdm.c")
code_health_score(file_path="E:/SynologyDrive/research/_agentic_refactoring/Street Fighter/git_win10/3sx/src/sf33rd/Source/Game/engine/plpdm.c")
```

The score must read 3.68. If it does not, this file changed after the task
...
| --- | --- | --- | --- | --- | --- |
| 1 | `subtract_dm_vital` | 1442 | 30 | - | 4 |
| 2 | `subtract_dm_vital_aiuchi` | 1520 | 21 | - | 3 |
| 3 | `get_damage_reaction_data` | 1581 | 16 | - | 3 |
| 4 | `setup_smoke_type` | 1308 | - | 4 | - |
| 5 | `set_dm_hos_flag_sky` | 1360 | 13 | - | 2 |
| 6 | `remake_initial_speeds` | 423 | 12 | - | 2 |
...
```bash
python tools/refactor_guard.py src/sf33rd/Source/Game/engine/plpdm.c
```
...
```
  ...
  This file has 1699 lines, so one function can move the aggregate score by
  ...
  `git checkout -- src/sf33rd/Source/Game/engine/plpdm.c` and move on.
...
- [ ] `python tools/refactor_guard.py src/sf33rd/Source/Game/engine/plpdm.c` reports no removed literals
